...
//        robot.gripperDr.setPosition(robot.gripperDrDeschis);
        ...
        //stopAllMotion();
        robot.navigation.strafeRight(10, 0.3);
        sleep(1000);
        robot.pivot.setPosition(robot.pivotScorat);
        sleep(1000);
        strafeRight(190, 0.3);
        driveBackward(10,0.2);
    ...
    public void EncoderDrive (double speed_RF,double speed_RB,double speed_LF,double speed_LB, double distance, double timeoutS)
    {
        if (opModeIsActive()) {
            ...
            if (opModeIsActive()) {
                ...
                robot.rightMotorBack.setTargetPositionTolerance(20);
                robot.rightMotorFront.setTargetPositionTolerance(20);
                robot.leftMotorBack.setTargetPositionTolerance(20);
                robot.leftMotorFront.setTargetPositionTolerance(20);
